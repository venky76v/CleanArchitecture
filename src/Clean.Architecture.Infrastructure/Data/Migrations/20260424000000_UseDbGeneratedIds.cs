...
public partial class UseDbGeneratedIds : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.Sql("EXEC sp_rename N'[dbo].[Contributors]', N'Contributors_old'");
      migrationBuilder.Sql("EXEC sp_rename N'[dbo].[PK_Contributors]', N'PK_Contributors_old', N'OBJECT'");
